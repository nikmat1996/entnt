...
export default ({ person }) => {
    ...
    return (
        <li className="flex relative justify-between gap-x-6 px-5 py-2 bg-slate-800 rounded-2xl group/li hover:bg-blue-950 transition-all hover:shadow-lg selection:text-sky-900 selection:bg-blue-400">
            <section className="flex min-w-0 py-4 gap-x-4 group/s1 border-r border-blue-900 w-1/3 items-center">
                ...
                <button className="flex items-center invisible peer-hover:invisible group-hover/s1:visible rounded-3xl border group/edit border-gray-500 cursor-pointer  h-6 p-2 mr-5 opacity-75 hover:opacity-100 hover:bg-slate-800">
